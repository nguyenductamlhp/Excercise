...
<body>
	...
	<ul>
		<li><a href="6/conghaisonguyen.jsp">Cộng hai số nguyên</a></li>
		<li><a href="6/truhaisonguyen.jsp">Trừ hai số nguyên</a></li>
		<li><a href="6/nhanhaisonguyen.jsp">Nhân 2 số nguyên</a></li>
	</ul>
